...
\DeclareMathOperator{\dom}{dom} % Define \dom for domain

\newcommand{\mtrix}[1]{\underline{\underline{#1}}}
%% /Custom operators
\definecolor{lightmagenta}{rgb}{0.95,0.7,0.95}
\definecolor{lightblue}{rgb}{0.7,0.85,0.95}
\definecolor{lightgreen}{rgb}{0.7,0.95,0.7}

% Language-dependent labels: default to Danish, allow override by calling
% `\documentLanguage{...}` earlier in the preamble. The setter stores the
% value in `\documentLanguageValue` which is safe to read here.
\usepackage{xstring}
\providecommand{\documentLanguageValue}{danish}
\providecommand{\bemærklabel}{\textbf{Bemærk: }}
\IfStrEq{\documentLanguageValue}{english}{\renewcommand{\bemærklabel}{\textbf{Notice: }}}{}
