...
\[
    [L(v)]_\gamma = \gamma [L]_\beta \cdot [v]_\beta \hspace{4em}
    _\delta [M \circ L]_\beta = _\delta [M]_\gamma \cdot _\gamma [L]_\beta
    \kildetag{Sætning 11.3.4}
\]
...
$\ker(L)$ kan findes ved at løse 
\(_\gamma [L]_\beta \cdot [\vec v]_\beta = 0\)
hvor $\vec v$ er løsningen til $L(\vec{v}) = 0$.
