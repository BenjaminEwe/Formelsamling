...
ved at finde koordinaterne for hver eneste basisvektor i $\gamma$ i forhold til basisen $\beta$ som ovenstående.
...
\subsection{Dimension af underrum}
...
%% Make a 4x4 upper-triangular matrix as an example
\[
\begin{bmatrix}
...
Givet en ordnet basis $\beta$ for vektorrum $V$, og vektorer i $V$ $v_1, v_2, \cdots, v_n$, 
så kan den ordnede basis for $\spanop(v_1, v_2, \cdots, v_m)$ findes ved ligsom i sektion \ref{sec:ordnet-basis-udspaending} at række-reducere følgende matrice 
og tage de vektorer der har pivot.
\[\begin{bmatrix}
    \vert & \vert & & \vert \\
    [\mathbf{v}_1]_\beta & [\mathbf{v}_2]_\beta & \cdots & [\mathbf{v}_n]_\beta \\
    \vert & \vert & & \vert
\end{bmatrix}\]
